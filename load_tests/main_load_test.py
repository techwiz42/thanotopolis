...
from scenarios.auth_load_test import AuthenticationUser
from scenarios.crm_load_test import CRMUser
from scenarios.calendar_load_test import CalendarUser
from scenarios.telephony_load_test import TelephonyUser
