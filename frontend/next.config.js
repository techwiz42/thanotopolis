    ...
    return [
      {
        ...
        headers: [
          ...
          { 
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://dev.thanotopolis.com wss://dev.thanotopolis.com http://localhost:* ws://localhost:*; frame-ancestors 'none';"
          },
        ]
      }
    ];
